...
import { findUserByEmail, saveSession } from "@/src/lib/storage";
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full">
      ...
      <label className="flex items-center gap-2.5 cursor-pointer">
        ...
        <span className="text-xs text-gray-400">
          Persist session on this hardware
        </span>
      </label>
      ...
      <button
        ...
        type="submit"
        className="w-full bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white py-3 rounded-xl text-sm font-semibold flex items-center justify-center gap-2 transition-colors shadow-md shadow-blue-200"
      >
        login
        <ArrowIcon />
      </button>
